...
namespace WindowsFormsApp2 {
    ...
    public partial class dbqueueDataSet : global::System.Data.DataSet {
        ...
        public partial class ClientsDataTable : global::System.Data.TypedTableBase<ClientsRow> {
            ...
            [global::System.Diagnostics.DebuggerNonUserCodeAttribute()]
            [global::System.CodeDom.Compiler.GeneratedCodeAttribute("System.Data.Design.TypedDataSetGenerator", "17.0.0.0")]
            public ClientsRow AddClientsRow(string ClientName, System.DateTime TransactionDate, int QueuePosition, string RequirementsStatus, string PaymentStatus) {
            ...
            private void InitClass() {
                ...
                this.columnRequirementsStatus.MaxLength = 50;
...
namespace WindowsFormsApp2.dbqueueDataSetTableAdapters {
    ...
    public partial class ClientsTableAdapter : global::System.ComponentModel.Component {
        ...
        private void InitAdapter() {
            ...
            this._adapter.DeleteCommand.CommandText = @"DELETE FROM [dbo].[Clients] WHERE (([ClientID] = @Original_ClientID) AND ([ClientName] = @Original_ClientName) AND ((@IsNull_TransactionDate = 1 AND [TransactionDate] IS NULL) OR ([TransactionDate] = @Original_TransactionDate)) AND ([QueuePosition] = @Original_QueuePosition) AND ((@IsNull_RequirementsStatus = 1 AND [RequirementsStatus] IS NULL) OR ([RequirementsStatus] = @Original_RequirementsStatus)) AND ((@IsNull_PaymentStatus = 1 AND [PaymentStatus] IS NULL) OR ([PaymentStatus] = @Original_PaymentStatus)))";
            ...
            this._adapter.InsertCommand.CommandText = @"INSERT INTO [dbo].[Clients] ([ClientName], [TransactionDate], [QueuePosition], [RequirementsStatus], [PaymentStatus]) VALUES (@ClientName, @TransactionDate, @QueuePosition, @RequirementsStatus, @PaymentStatus);
SELECT ClientID, ClientName, TransactionDate, QueuePosition, RequirementsStatus, PaymentStatus FROM Clients WHERE (ClientID = SCOPE_IDENTITY())";
            ...
            this._adapter.UpdateCommand.CommandText = @"UPDATE [dbo].[Clients] SET [ClientName] = @ClientName, [TransactionDate] = @TransactionDate, [QueuePosition] = @QueuePosition, [RequirementsStatus] = @RequirementsStatus, [PaymentStatus] = @PaymentStatus WHERE (([ClientID] = @Original_ClientID) AND ([ClientName] = @Original_ClientName) AND ((@IsNull_TransactionDate = 1 AND [TransactionDate] IS NULL) OR ([TransactionDate] = @Original_TransactionDate)) AND ([QueuePosition] = @Original_QueuePosition) AND ((@IsNull_RequirementsStatus = 1 AND [RequirementsStatus] IS NULL) OR ([RequirementsStatus] = @Original_RequirementsStatus)) AND ((@IsNull_PaymentStatus = 1 AND [PaymentStatus] IS NULL) OR ([PaymentStatus] = @Original_PaymentStatus)));
SELECT ClientID, ClientName, TransactionDate, QueuePosition, RequirementsStatus, PaymentStatus FROM Clients WHERE (ClientID = @ClientID)";
        ...
        public virtual int Delete(int Original_ClientID, string Original_ClientName, global::System.Nullable<global::System.DateTime> Original_TransactionDate, int Original_QueuePosition, string Original_RequirementsStatus, string Original_PaymentStatus) {
            ...
            if ((Original_RequirementsStatus == null)) {
                ...
                this.Adapter.DeleteCommand.Parameters[6].Value = ((string)(Original_RequirementsStatus));
            }
        ...
        public virtual int Insert(string ClientName, global::System.Nullable<global::System.DateTime> TransactionDate, int QueuePosition, string RequirementsStatus, string PaymentStatus) {
            if ((ClientName == null)) {
        ...
        public virtual int Update(string ClientName, global::System.Nullable<global::System.DateTime> TransactionDate, int QueuePosition, string RequirementsStatus, string PaymentStatus, int Original_ClientID, string Original_ClientName, global::System.Nullable<global::System.DateTime> Original_TransactionDate, int Original_QueuePosition, string Original_RequirementsStatus, string Original_PaymentStatus, int ClientID) {
            if ((ClientName == null)) {
                throw new global::System.ArgumentNullException("ClientName");
            }
            else {
        ...
        public virtual int Update(string ClientName, global::System.Nullable<global::System.DateTime> TransactionDate, int QueuePosition, string RequirementsStatus, string PaymentStatus, int Original_ClientID, string Original_ClientName, global::System.Nullable<global::System.DateTime> Original_TransactionDate, int Original_QueuePosition, string Original_RequirementsStatus, string Original_PaymentStatus) {
            return this.Update(ClientName, TransactionDate, QueuePosition, RequirementsStatus, PaymentStatus, Original_ClientID, Original_ClientName, Original_TransactionDate, Original_QueuePosition, Original_RequirementsStatus, Original_PaymentStatus, Original_ClientID);
        }
    }
